...
<div style="text-align: center">
    ...
    <div> please click the following link to complete registeration in our site</div>
   ...
   ;color: white;font-size: 15px;padding: 5px;margin-top: 20px;cursor:hand;width:25%;margin:20px auto">
    <a href="{{url($ver)}}" style="font-size: 20px;color:white;text-decoration: none" >Continue Registeration </a>
    </div>
    </div>
</body>
</html>
